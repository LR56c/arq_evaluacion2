...
//     }
//
//     const updatedName = wrapTypeDefault( prevUser.name,
//       ( value ) => ValidString.from( value ), dto.name )
//
//     if ( updatedName instanceof BaseException ) {
//       errors.push( updatedName )
//     }
//
//     const updatedColor = wrapTypeDefault( prevUser.color,
//       ( value ) => ValidString.from( value ), dto.color )
//
//     if ( updatedColor instanceof BaseException ) {
//       errors.push( updatedColor )
//     }
//
//     if ( errors.length ) {
//       return left( errors )
...
//       prevUser.email,
//       newRoles,
//       updatedColor as ValidString,
//       prevUser.createdAt,
//       updatedName as ValidString | undefined
//     )
//
