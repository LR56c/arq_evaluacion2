...
import {
  searchCountry
}                         from "~~/server/dependencies/country_dependencies"
import {
  searchUser
...
export const searchAddress   = new SearchAddress( dao )
...
export const addressService  = new AddressService( add, remove, searchAddress, update,
  addressInstrumentation )
